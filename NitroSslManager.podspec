...
Pod::Spec.new do |s|
  ...
  # Handwritten iOS sources (Swift HybridObject + Objective-C++ launch bootstrap)
  ...
  # Add all files generated by Nitrogen (specs, bridges, xcconfig, NitroModules dep)
  load 'nitrogen/generated/ios/NitroSslManager+autolinking.rb'
  add_nitrogen_files(s)

  # Links React Native core and the Nitro runtime
