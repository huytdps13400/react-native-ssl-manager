import { withAndroidManifest, withInfoPlist, withXcodeProject, } from '@expo/config-plugins';
...
const withUseSslPinning = (config, options = {}) => {
    ...
    if (enableIOS) {
        ...
        config = withXcodeProject(config, (config) => {
            ...
            const libraryPath = path.join(process.cwd(), 'node_modules/react-native-ssl-manager');
